All files are available at the following link:
...
Before running the training or testing code, drag and drop all files and folders into the Google Colab file explorer.
